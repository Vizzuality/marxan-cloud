...
const planningAreaId = await bot.planningAreaUploader.uploadFromFile(`${scriptPath}/kimberley.zip`);
...
await bot.scenarioStatus.waitForFeatureSpecificationCalculationFor(project.id, scenario.id, 'some');
