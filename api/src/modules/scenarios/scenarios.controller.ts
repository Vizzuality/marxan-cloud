...
import { ScenarioFeatureFacade } from '../scenarios-features';
...
export class ScenariosController {
  constructor(
    ...
    private readonly scenarioFeatures: ScenarioFeatureFacade,
  ) {}
  ...
  async getScenarioFeatures(
    ...
    const features = await this.scenarioFeatures.forScenario(id);
