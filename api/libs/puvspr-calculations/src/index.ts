export { TypeOrmPuvsprCalculationsRepository } from './repository/typeorm-puvspr-calculations.repository';
...
export { PuvsprCalculationsModule } from './puvspr-calculations.module';
