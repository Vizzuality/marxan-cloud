...
export class AddFeatureTagTable1685458802957 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE project_feature_tags (
      ...
      tag_lower varchar generated always as (lower(tag)) stored
    );`);

    await queryRunner.query(`
      ALTER TABLE project_feature_tags ADD CONSTRAINT consistent_tag_capitalization EXCLUDE USING gist (tag WITH <>, tag_lower WITH =, project_id WITH =) DEFERRABLE INITIALLY DEFERRED;
    `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        DROP FUNCTION tr_equivalent_capitalization_tag cascade;
