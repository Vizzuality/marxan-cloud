...
export class MarxanExecutionMetadata1625494224067
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "marxan_execution_metadata" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "scenarioId" character varying NOT NULL, "std_out" character varying, "std_err" character varying, "input_zip" bytea NOT NULL, "output_zip" bytea, CONSTRAINT "PK_3926acd5285d86ad395507b5982" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
