    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        {!allFeaturesQuery.isFetching && (
          <div
            className={cn({
              "flex min-h-0 flex-grow flex-col overflow-hidden before:absolute before:left-0 before:top-0 before:z-10 before:h-6 before:w-[calc(100%-20px)] before:bg-gradient-to-b before:from-gray-700 before:content-[''] after:absolute after:bottom-0 after:left-0 after:z-10 after:h-6 after:w-[calc(100%-20px)] after:bg-gradient-to-t after:from-gray-700 after:content-['']":
                true,
              'after:bottom-12': selectedFeaturesIds.length > 0,
            })}
          >
            <ul className="max-h-[calc(100vh-400px)] divide-y divide-gray-400 overflow-y-auto py-3 pl-1 pr-2">
              {allFeaturesQuery.data?.map((feature) => (
                <li key={feature.id} className="flex items-center justify-between py-3">
                  <FeatureItemList
                    feature={feature}
                    projectId={pid}
