                  ...
                  <InfoButton size="base" theme="primary">
                    <span className="text-xs">
                      ...
                      <ul className="list-disc space-y-1 pl-6">
                        <li>
                          features that are not meant to be split must not contain any overlapping
                          geometries;
                        </li>
                        <li>
                          features that are meant for splitting can contain geometries that overlap
                          but only between sub-features that will be obtained through splitting the
                          uploaded feature, and they must not have any overlaps within the set of
                          geometries that are meant to be part of a single sub-feature;
                        </li>
                        <li>
...
export default FeaturesUploader;
