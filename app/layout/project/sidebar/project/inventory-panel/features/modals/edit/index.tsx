        ...
        return (
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-5 px-8 py-1">
              <h2 className="font-heading font-bold text-black">Upload feauture</h2>
                ...
                <FieldRFF name="name" validate={composeValidators([{ presence: true }])}>
                  {(fprops) => (
                    <Field id="form-name" {...fprops}>
                      ...
                      <Input className="rounded-md" theme="light" />
                    </Field>
                  )}
                </FieldRFF>
              </div>
              ...
              <div>
                <FieldRFF name="type" validate={composeValidators([{ presence: true }])}>
                  {(fprops) => (
                    <Field id="form-type" {...fprops}>
                      <Label theme="light" className="mb-3 uppercase">
                        Add type
                      </Label>
                      <Input
