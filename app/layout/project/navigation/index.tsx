...
export const MenuTooltip = ({ children }: PropsWithChildren): JSX.Element => {
  return (
    <div className="rounded-xl border border-gray-600 bg-gray-800 px-2 py-[0.5px] text-sm text-blue-300">
      {children}
    </div>
  );
};
