    ...
    <div>
      ...
      <div className="space-y-5">
        ...
        <a
          ...
          type="button"
          role="button"
          href={`https://twitter.com/intent/tweet?url=${process.env.NEXT_PUBLIC_API_URL}${asPath}`}
          rel="noreferrer"
          target="_blank"
        >
        ...
        <a
          ...
          type="button"
          role="button"
          href={`https://www.facebook.com/sharer/sharer.php?u=${process.env.NEXT_PUBLIC_API_URL}${asPath}`}
          rel="noreferrer"
          target="_blank"
        >
