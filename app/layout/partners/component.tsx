...
export const PartnersList: React.FC<PartnersListProps> = () => {
  return (
    <div className="bg-white">
      <Wrapper>
        <div className="flex flex-col items-center w-full max-w-5xl pt-12 mx-auto">
          <h2 className="pb-20 text-2xl leading-relaxed text-black font-heading max-w-max bg-clip-text">
            Brought to you by:
          </h2>
          <div className="grid w-full grid-cols-1 py-10 md:grid-cols-2 gap-x-56 gap-y-24">
        ...
        <div className="relative flex flex-col items-center w-full max-w-5xl pt-24 pb-20 mx-auto border-t border-black border-opacity-20">
          ...
          <div className="grid w-full grid-cols-1 py-10 md:grid-cols-5 gap-x-16 gap-y-24">
        ...
        <div className="relative flex flex-col items-center w-full max-w-5xl pt-24 pb-20 mx-auto border-t border-black border-opacity-20">
          ...
          <div className="grid w-full grid-cols-1 py-10 md:grid-cols-1 gap-x-16 gap-y-24">
