...
export const FIELDS = [
  ...
  },
  {
    id: 'INPUTDIR',
    label: 'Input Folder',
    description: <p>User Defined Name of the folder containing input data files</p>,
    category: {
      id: 'input-files',
      label: 'Input files',
    },
  ...
  },
  {
    ...
    description: (<p>Name of Conservation Feature File. It contains information about each of the conservation features being considered, such as their name, targets and representation requirements, and the penalty that should be applied if these representation requirements are not met.</p>),
    category: {
      id: 'input-files',
      label: 'Input files',
    },
  ...
  },
  {
    ...
    description: (<p>Name of Planning Unit File. It contains information about the planning units themselves, such as ID number, cost, location and status.</p>),
    category: {
      id: 'input-files',
      label: 'Input files',
    },
  ...
  },
  {
    ...
    description: (<p>Name of Planning Unit versus Conservation Feature File. Tt contains information on the distribution of conservation features in each of the planning units.</p>),
    category: {
      id: 'input-files',
      label: 'Input files',
    },
  ...
  },
  {
    ...
    description: (<p>Name of Boundary Length File. It contains information about the length or ‘effective length’ of shared boundaries between planning units. This file is necessary if you wish to use the Boundary Length Modifier to improve the compactness of reserve solutions, and while not required, is recommended.</p>),
    category: {
      id: 'input-files',
      label: 'Input files',
    },
