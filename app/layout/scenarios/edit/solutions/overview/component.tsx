    ...
    >
      ...
      <div className="relative flex flex-col flex-grow w-full">
        <div className="relative flex flex-col w-full mt-1 text-sm">
          ...
          <div className="w-full pb-6 border-gray-600">
            <SolutionSelected
              best={isBestSolution}
          ...
          <div className="">
            <Button
              theme="primary"
              size="base"
              className="flex w-full h-12 mb-4 space-x-2"
              onClick={() => setShowTable(true)}
            >
              <span>View solutions table</span>
              <Icon icon={TABLE_SVG} className="w-4 h-4 right-8" />
            </Button>

            <Button
              theme="primary-alt"
              size="base"
              className="flex w-full h-12 mb-4 overflow-hidden"
              disabled={PDFLoader}
