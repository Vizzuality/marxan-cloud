          ...
          <div>
            ...
            <ul>
              <li>
                ...
                by a website, containing the details of Your browsing history on that website
                among its many uses.
              </li>
              <li>
            ...
            <p className="pl-10">
              ...
              available through the Website and to enable You to use some of its features. They help
              to authenticate users and prevent fraudulent use of user accounts. Without these
            ...
            <h2 className="font-semibold">Your California Privacy Rights (California’s Shine the Light law)</h2>
            <p>
            ...
            <ul>
              <li>By email: marxancloud@gmail.com</li>
            </ul>
          </div>
        </div>
