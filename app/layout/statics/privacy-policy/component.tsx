          ...
          <div className="space-y-24">
            ...
            <div>
              ...
              <div className="space-y-12">
                <div>
                  <h3 className="font-semibold underline">Interpretation</h3>
                  <br />
                  <p>
                ...
                <div>
                  <h3 className="font-semibold underline">Definitions</h3>
                  <br />
                  ...
                  <ul className="pl-10 space-y-4 list-disc">
                    ...
                    <li>
                      ...
                      {' '}
                      refers to marxan, accessible from www.marxansolutions.org
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      {' '}
                      refers to: Queensland, Australia
                      <ul className="pl-20 my-4 list-disc">
                        <li>
                  ...
                  <ul className="pl-10 mb-4 list-disc">
                    <li>
                      ...
                      <ul className="pl-20 mt-4 list-disc">
                        <li>
            ...
            <div>
              ...
              <p>
                ...
                deleted as soon as You close your web browser. Learn more about cookies in the
                {' '}
              ...
              <br />
              <p className="pl-10">Administered by: Us</p>
              <br />
              <p className="pl-10">
              ...
              <p className="pl-10">Type: Persistent Cookies</p>
              <br />
              <p className="pl-10">Administered by: Third-Parties</p>
              <br />
              <p className="pl-10">
                ...
                directly or indirectly identify you as an individual visitor. This is because
                ...
                Cookies to test new advertisements, pages, features or new functionality of
            ...
            <div>
              ...
              <p>
                ...
                rom anyone under  the age of 13 without verification of parental consent, We take
            ...
            <div>
              ...
              <p>
                ...
                information once a year about sharing their Personal Data with third parties for
