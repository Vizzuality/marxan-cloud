...
export const FEATURES = [
  ...
  },
  {
    ...
    iconClassName: 'w-6 h-6 text-purple-200 stroke-current',
  },
  {
    id: 'cloud-storage',
    name: 'Cloud storage',
    ...
    iconClassName: 'w-6 h-6 text-purple-50',
  },
  {
    id: 'collaborate',
    ...
    iconClassName: 'w-6 h-6 text-blue-50',
  },
  {
    ...
    iconClassName: 'w-6 h-6 text-blue-200',
  },
];
